...
class VoucherHeadScreen extends StatefulWidget {
  const VoucherHeadScreen({super.key});

  @override
  State<VoucherHeadScreen> createState() => _VoucherHeadScreenState();
}

class _VoucherHeadScreenState extends State<VoucherHeadScreen> {
  String _searchQuery = '';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  AppSpacing.vMd,
                  _buildDetailRow('Opening Balance:', '₹${numberFormatBalance(head['openingBalance'])}', isDark),
  ...
  String numberFormatBalance(dynamic val) {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    AppSpacing.vMd,
                    AppTextField(controller: codeController, label: 'Head Code *', hint: 'e.g., VH-003'),
                    AppSpacing.vMd,
                    Row(
                      children: [
                        Expanded(
    ...
    final headerTexts = Column(
      ...
      children: [
        Row(
          children: [
            InkWell(
              onTap: () => context.go(RouteNames.expenseVoucherHeadPath),
              child: Text(
                'Expense',
                style: AppTypography.bodySmall.copyWith(
                  color: isDark ? AppColors.textMutedDark : AppColors.textMutedLight,
        ...
        AppSpacing.vXs,
        Text(
          'Manage categories for your vouchers',
