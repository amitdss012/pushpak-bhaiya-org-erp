...
class GenerateCertificatesScreen extends StatefulWidget {
  const GenerateCertificatesScreen({super.key});

  @override
  State<GenerateCertificatesScreen> createState() => _GenerateCertificatesScreenState();
}

class _GenerateCertificatesScreenState extends State<GenerateCertificatesScreen> {
  String _selectedType = 'character';
  ...
  Widget _buildFiltersCard(bool isDark) {
    return AppCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Certificate Options', style: AppTypography.titleMedium.copyWith(fontWeight: FontWeight.w700)),
          AppSpacing.vLg,
          ...
          DropdownButtonFormField<String>(
            ...
            items: const [
              ...
              DropdownMenuItem(value: 'transfer', child: Text('Transfer Certificate')),
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: const InputDecoration(),
            items: const [
              DropdownMenuItem(value: '1', child: Text('Character Certificate Template')),
              DropdownMenuItem(value: '2', child: Text('Transfer Certificate (TC) Template')),
              DropdownMenuItem(value: '3', child: Text('Bonafide Certificate Template')),
              DropdownMenuItem(value: '4', child: Text('Merit Certificate Template')),
              DropdownMenuItem(value: '5', child: Text('Participation Certificate Template')),
            ],
          ...
          Row(
            children: [
              Icon(Icons.military_tech_outlined, size: 16, color: isDark ? AppColors.textMutedDark : AppColors.textMutedLight),
              AppSpacing.hSm,
              Text('Certificates to generate: ${_selectedStudentIds.length}', style: AppTypography.bodySmall),
            ],
          ),
          AppSpacing.vSm,
          Row(
            children: [
              ...
              AppSpacing.hSm,
              Text('Type: Character Certificate', style: AppTypography.bodySmall),
            ],
          ),
          AppSpacing.vLg,
          Column(
            ...
            children: [
              AppButton(
                text: 'Preview Certificates',
                icon: Icons.visibility_outlined,
                onPressed: _selectedStudentIds.isEmpty
                    ? null
                    : () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Previewing ${_selectedStudentIds.length} certificates...')),
                        );
                      },
              ),
              AppSpacing.vSm,
              AppButton(
                ...
                onPressed: _selectedStudentIds.isEmpty
                    ...
                    : () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Printing ${_selectedStudentIds.length} certificates...')),
                        );
                      },
              ),
              AppSpacing.vSm,
              AppButton(
                ...
                onPressed: _selectedStudentIds.isEmpty
                    ...
                    : () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Downloading certificates PDF...')),
                        );
                      },
              ),
            ],
                ...
                child: ConstrainedBox(
                  ...
                  child: DataTable(
                    ...
                    rows: filteredStudents.map((student) {
                      ...
                      final isTcIssued = status == 'tc_issued';
                        ...
                        cells: [
                          ...
                          DataCell(
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isTcIssued ? AppColors.warning.withAlpha(20) : AppColors.success.withAlpha(20),
                                borderRadius: AppRadius.sm,
                                border: Border.all(color: isTcIssued ? AppColors.warning.withAlpha(60) : AppColors.success.withAlpha(60)),
                              ),
                              child: Text(
                                isTcIssued ? 'TC Issued' : 'Active',
                                style: AppTypography.bodySmall.copyWith(
                                  fontSize: 11,
                                  fontWeight: FontWeight.w700,
                                  color: isTcIssued ? AppColors.warning : AppColors.success,
                                ),
                              ),
                            ),
                          ),
  ...
  Widget _buildHeader(bool isDark) {
    return Column(
      ...
      children: [
        ...
        AppSpacing.vXs,
        Text(
          'Generate and print certificates for students',
